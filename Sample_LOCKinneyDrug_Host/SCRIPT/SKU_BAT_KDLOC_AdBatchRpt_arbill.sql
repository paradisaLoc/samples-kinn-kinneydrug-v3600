/* Ad Batch Report: AR Bill from Ad Sheets */
...
/* AR Bills from Ad Sheets */
@wizrpl(ExtGridUsp=Kinney_ARBill_xls);
@WIZSET(FILENAME=Kinney_ARBill.xls);
@WIZRPL(OUTPUT=@OFFICEDBT\@WIZGET(FILENAME))
@EXEC(XLS=RTM\Kinney_ARBill.xls)
@wizClr(OUTPUT);
